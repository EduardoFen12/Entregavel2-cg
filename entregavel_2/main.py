...
def main():
    ...
    glfw.swap_interval(0) # aqui nos determinamos quantos fps o glfw deve esperar antes de trocar os buffers, no caso, antes de mostrar o próximo frame
    #0= sem espera nenhuma V-Sync desligado ( FPS destravado)
    #1=  espera 1 refresh do monitor V-Sync ligado  (FPS limitado a 60 Hz)
...
-0.5, 0.5, -0.5, 0.0, 1.0 # 35
    ...
    # configuração do fps counter antes do loop
